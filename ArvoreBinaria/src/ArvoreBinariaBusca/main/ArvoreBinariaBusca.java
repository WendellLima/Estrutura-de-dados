...
public class ArvoreBinariaBusca {
	...
	public void getPai(int valor) {
		No no = buscar(valor);
		if(no.pai != null) {
			System.out.println("O pai do nÃ³" + valor + " Ã© " + no.pai.valor);
		}else {
			System.out.println("O nÃ³ " + valor + " Ã© a raiz da Ã¡rvore.");
		}
	...
	public void busca (No no, int valor) {
		System.out.println("focando no nÃ³ " + no.valor);
		if (no.valor == valor) {
			System.out.println("O nÃ³ " + valor + " foi encontrado.");
			...
			System.out.println("O nÃ³ " + valor + " nÃ£o foi incontrado.");
		}
	}
	...
	//Pos ordem ou EDR
			...
			public No buscar (No no, int valor) {
				...
				// impressÃ£o do caminho que foi pecorrido
				//System.out.println("focando no nÃ³ " + no.valor + "\t");
				if (no.valor == valor) {
					//System.out.println("O nÃ³ " + valor + " foi encontrado.");
					return no;
